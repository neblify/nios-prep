      ...
      <div className="mx-auto max-w-7xl pb-16 pt-20 sm:pb-24 sm:pt-24 lg:pb-32 lg:pt-32">
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            ...
            >
              <Button asChild size="lg" className="px-8 py-6 text-base font-medium md:text-lg shadow-lg hover:shadow-xl transition-all bg-indigo-600 hover:bg-indigo-700 text-white">
                <Link href="/sign-up">
                  Start Learning Free
