                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                    ...
                    <div className="mt-10 md:mt-0 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                        ...
                        >
                            ...
                            <div aria-hidden="true" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-50 rounded-full blur-3xl opacity-50" />
                            <div aria-hidden="true" className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-blue-50 rounded-full blur-3xl opacity-50" />
