                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {results.map((result: any) => {
                                    ...
                                    if (percentage >= 80) gradeColor = 'bg-green-100 text-green-800';
                                    else if (percentage >= 60) gradeColor = 'bg-blue-100 text-blue-800';
                                    else if (percentage >= 40) gradeColor = 'bg-yellow-100 text-yellow-800';
                                    ...
                                    return (
                                        <tr key={result._id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${gradeColor}`}>
                                                    {percentage}%
                                                </span>
                                            </td>
